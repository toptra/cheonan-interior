...
PAGES.append(dict(
    ...
    h1="천안 욕실 인테리어",
    title="천안 화장실 인테리어 - 천안 욕실 리모델링·화장실 타일·방수·도기교체",
...
PAGES.append(dict(
    ...
    h1="천안 인테리어 업체 추천 · 고르는 법",
    title="천안 인테리어 업체 추천 - 고르는 법·비교 기준·견적 체크리스트",
    desc="천안 인테리어 업체 고르는 법 정리. 포트폴리오·견적 투명성·A/S·시공 기간·후기 등 비교 기준과 지역별 업체 특성, 계약 전 확인할 체크리스트, 업체 선정 시 자주 하는 실수를 안내합니다.",
    keywords="천안인테리어업체,천안인테리어업체추천,천안인테리어업체순위,천안아파트인테리어업체,천안인테리어업체후기,천안인테리어잘하는곳,천안리모델링업체,천안인테리어업체비교",
    hero=unsplash("1600880292203-757bb62b4baf"), hero_alt="천안 인테리어 업체 상담 - 견적 비교",
    serviceType=["인테리어업체추천","인테리어업체비교","인테리어상담"],
    aeo="<strong>천안 인테리어 업체</strong>를 고를 때는 가격만 보지 말고 <strong>① 시공 포트폴리오 ② 견적의 투명성 ③ A/S 조건 ④ 시공 기간 ⑤ 실제 후기</strong> 5가지를 함께 비교하는 것이 핵심입니다. 특히 '평당 단가'만 낮은 업체는 조명·전기·확장 같은 항목이 빠져 있을 수 있어, 같은 조건으로 맞춰 비교해야 합니다.",
    body="""
