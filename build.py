...
FOOTER_COLS = [
    ...
    ("정보", [
        ("/cheonan-interior-company",  "천안 인테리어 업체"),
...
PAGES.append(dict(
    ...
    h1="천안 욕실 인테리어",
    title="천안 화장실 인테리어 - 천안 욕실 리모델링·타일·방수",
    desc="천안 화장실 인테리어·욕실 리모델링 전문 정보. 방수·타일·도기(변기·세면대·수전) 교체, 건식/습식 구성, 노후 화장실 리모델링 절차와 방수 하자 주의점, 개소별 비용 기준을 안내합니다.",
    keywords="천안화장실인테리어,천안화장실리모델링,천안욕실인테리어,천안욕실리모델링,천안화장실타일,천안욕실타일,천안욕실방수,천안변기교체,천안세면대교체,천안화장실덧방",
    hero=unsplash("1600566752355-35792bedcfea"), hero_alt="천안 욕실 인테리어 시공 사례 - 모던 욕실 리모델링",
    serviceType=["욕실인테리어","욕실리모델링","타일시공","방수공사","도기교체"],
    aeo="<strong>천안 화장실 인테리어(욕실 리모델링)</strong>는 타일·도기(변기·세면대·수전)·방수·조명을 교체하는 공사로, 방수가 가장 중요한 공정입니다. 천안 지역 표준 화장실 1개소 기준 <strong>200~500만 원</strong> 선이며, 철거 범위·타일 등급·건식 구성 여부에 따라 달라집니다. 공사는 보통 3~5일 소요됩니다.",
    body="""
<h2>천안 화장실 인테리어와 욕실 리모델링의 차이</h2>
<p>천안에서는 <strong>화장실 인테리어</strong>와 <strong>욕실 리모델링</strong>을 사실상 같은 공사로 부릅니다. 표현만 다를 뿐, 변기·세면대·타일·방수를 새로 하는 작업을 뜻합니다. 굳이 나누자면 '화장실'은 변기 중심의 위생 공간, '욕실'은 샤워·욕조가 포함된 공간을 가리키지만, 시공 범위와 비용은 거의 동일합니다. 아파트 공용 화장실 하나만 바꾸는 부분 공사부터, 안방 욕실까지 두 곳을 함께 하는 전체 리모델링까지 규모는 다양합니다.</p>
<h2>욕실·화장실 리모델링 시공 범위</h2>
<ul class="spec-list">
...
""",
    faq=[
      ("천안 화장실 인테리어 비용은 얼마인가요?","천안 화장실 인테리어(욕실 리모델링)는 표준 1개소 기준 약 200~500만 원 선입니다. 타일 등급, 도기 브랜드, 건식 구성(샤워부스) 여부에 따라 달라지며, 화장실 두 곳을 함께 하면 개소당 단가가 낮아집니다."),
...
# 9) 업체 추천/비교 (인텐트: 천안인테리어업체)
PAGES.append(dict(
    slug="cheonan-interior-company", label="Company Guide · 천안",
    h1="천안 인테리어 업체 추천 · 잘하는 곳 고르는 법",
    title="천안 인테리어 업체 추천 - 잘하는 곳 고르는 법·비교 기준",
    desc="천안 인테리어 잘하는 곳 고르는 법 정리. 포트폴리오·견적 투명성·A/S·시공 기간·후기 등 업체 비교 기준과 지역별 특성, 계약 전 체크리스트, 업체 선정 시 자주 하는 실수를 안내합니다.",
    keywords="천안인테리어잘하는곳,천안인테리어업체,천안인테리어업체추천,천안인테리어추천,천안인테리어업체순위,천안아파트인테리어업체,천안인테리어업체후기,천안리모델링업체,천안인테리어업체비교,천안리모델링잘하는곳",
    hero=unsplash("1600880292203-757bb62b4baf"), hero_alt="천안 인테리어 업체 상담 - 견적 비교",
    serviceType=["인테리어업체추천","인테리어업체비교","인테리어상담"],
    aeo="<strong>천안 인테리어 잘하는 곳</strong>을 찾을 때는 가격만 보지 말고 <strong>① 시공 포트폴리오 ② 견적의 투명성 ③ A/S 조건 ④ 시공 기간 ⑤ 실제 후기</strong> 5가지를 함께 비교하는 것이 핵심입니다. 특히 '평당 단가'만 낮은 업체는 조명·전기·확장 같은 항목이 빠져 있을 수 있어, 같은 조건으로 맞춰 비교해야 진짜 잘하는 업체를 가려낼 수 있습니다.",
    body="""
<h2>천안 인테리어 잘하는 곳은 어떻게 알아볼까</h2>
<p>"잘하는 곳"의 기준은 사람마다 다르지만, 실제로 만족도가 갈리는 지점은 대부분 같습니다. <strong>디자인 감각보다 기본기(방수·전기·마감)와 사후 대응</strong>이 결과를 좌우합니다. 아래 신호가 보이면 신뢰할 만한 업체일 가능성이 높습니다.</p>
<ul class="spec-list">
  <li><b>보이지 않는 공정을 설명한다</b> — 방수·배관·전기처럼 마감에 가려지는 부분을 먼저 짚어주는 곳</li>
  <li><b>못 하는 것을 말한다</b> — 예산·구조상 불가능한 요구를 솔직히 거절하는 곳이 오히려 안전합니다</li>
  <li><b>견적서가 구체적이다</b> — 자재 사양·수량·단가가 적혀 있고, 제외 항목이 명시된 견적</li>
  <li><b>하자 대응 후기가 좋다</b> — 시공 직후 후기보다 <strong>공사 6개월 뒤 후기</strong>가 진짜 실력을 보여줍니다</li>
  <li><b>담당자가 끝까지 같다</b> — 상담자와 실제 시공팀이 다른 경우 소통 문제가 생기기 쉽습니다</li>
</ul>

<h2>천안 인테리어 업체 고르는 5가지 기준</h2>
<p>인테리어는 한 번 하면 다시 하기 어렵기 때문에 업체 선정이 결과의 대부분을 좌우합니다. 천안에서 업체를 비교할 때 아래 5가지를 기준으로 보세요.</p>
<div class="feature-grid">
  <div class="feature-card"><p class="fc-num">01</p><h3>시공 포트폴리오</h3><p>우리 집과 비슷한 평형·공간의 실제 시공 사례가 있는지. 사진만이 아니라 현장 주소·규모가 구체적일수록 신뢰도가 높습니다.</p></div>
  <div class="feature-card"><p class="fc-num">02</p><h3>견적의 투명성</h3><p>항목별로 나뉜 견적서인지. '일식(한 덩어리)' 견적보다 자재 사양·수량이 적힌 견적이 나중에 분쟁이 적습니다.</p></div>
  <div class="feature-card"><p class="fc-num">03</p><h3>A/S 조건</h3><p>하자 보수 기간과 범위가 계약서에 명시되는지. 방수·누수 같은 항목은 기간을 넉넉히 잡는 곳이 좋습니다.</p></div>
  <div class="feature-card"><p class="fc-num">04</p><h3>시공 기간·소통</h3><p>공정별 일정과 진행 상황을 공유하는지. 연락이 잘 되는지가 공사 중 스트레스를 크게 좌우합니다.</p></div>
</div>
<h3>05. 실제 후기</h3>
<p>카페·블로그의 실제 시공 후기를 확인하세요. 특히 <strong>공사 후 하자 대응</strong>에 대한 후기가 업체의 진짜 실력을 보여줍니다.</p>

<h2>업체 선정 시 자주 하는 실수</h2>
<ul class="spec-list">
  <li><b>평당 단가만 비교</b> — 포함 범위가 다르면 싼 게 아닙니다. 조명·전기·확장·철거가 빠졌는지 확인</li>
  <li><b>계약서 없이 구두 진행</b> — 범위·일정·A/S·대금 조건은 반드시 서면으로</li>
  <li><b>추가 비용 기준 미확인</b> — 철거 후 발견되는 하자의 처리 기준을 계약 전에 합의</li>
  <li><b>포트폴리오만 보고 결정</b> — 사진은 좋아도 시공 팀이 다를 수 있으니 실제 담당자 확인</li>
</ul>

<h2>천안 지역별 인테리어 업체 특성</h2>
<div class="region-grid">
  <div class="region-card"><h3>불당동 · 백석동</h3><p>신축·대단지 밀집으로 아파트 인테리어 업체가 많은 지역. 브랜드형·고급 시공 수요가 큽니다.</p></div>
  <div class="region-card"><h3>두정동 · 성정동</h3><p>천안역·터미널 상권. 상가·사무실 인테리어와 리모델링 업체가 모여 있습니다.</p></div>
  <div class="region-card"><h3>쌍용동 · 서북구</h3><p>주거·업무 혼합. 종합 인테리어·부분 시공 업체 선택지가 넓은 편입니다.</p></div>
  <div class="region-card"><h3>동남구 · 아산 인접</h3><p>천안아산역 생활권. 출장 상담을 함께 하는 업체가 많습니다.</p></div>
</div>

<h2>계약 전 체크리스트</h2>
<ul class="spec-list">
  <li><b>견적서</b>에 항목별 자재·수량·단가가 적혀 있는가</li>
  <li><b>공사 범위</b>와 제외 항목이 명확한가</li>
  <li><b>일정</b>(착공·준공)과 지연 시 처리가 정해졌는가</li>
  <li><b>A/S</b> 기간·범위가 서면에 있는가</li>
  <li><b>대금</b>은 공정 진행률에 맞춰 나눠 지급하는가(잔금은 하자 점검 후)</li>
</ul>
<p>분야별 비용 기준은 <a class="inline" href="/cheonan-interior-cost">천안 인테리어 비용 페이지</a>에서, 공사별 상세는 각 시공 페이지에서 확인할 수 있습니다.</p>
""",
    faq=[
      ("천안 인테리어 잘하는 곳은 어떻게 찾나요?","디자인보다 기본기와 사후 대응을 보세요. 방수·전기 같은 보이지 않는 공정을 먼저 설명하는지, 견적서에 자재 사양과 제외 항목이 적혀 있는지, 공사 6개월 뒤 후기가 좋은지가 핵심 판단 기준입니다."),
      ("천안 인테리어 업체는 어떻게 고르나요?","가격만 보지 말고 포트폴리오·견적 투명성·A/S·시공 기간·후기 5가지를 함께 비교하세요. 우리 집과 비슷한 평형의 시공 사례가 있는지, 견적서가 항목별로 나뉘어 있는지가 특히 중요합니다."),
      ("평당 단가만 보고 결정하면 안 되나요?","평당 단가만 낮은 업체는 조명·전기·확장·철거 같은 항목이 빠져 있을 수 있습니다. 같은 시공 범위·자재 등급으로 맞춰서 비교해야 실제 비용을 알 수 있습니다."),
      ("천안 인테리어 업체 견적은 무료인가요?","대부분 현장 실측·견적은 무료입니다. 다만 상세 도면이나 3D 설계가 포함되면 별도 비용이 있을 수 있으니 미리 확인하세요."),
      ("계약할 때 꼭 확인할 것은 무엇인가요?","공사 범위·제외 항목, 일정, A/S 기간·범위, 추가 비용 처리 기준, 대금 지급 방식입니다. 모두 서면으로 남기고 잔금은 하자 점검 후 지급하는 것이 안전합니다."),
    ],
    related=["cheonan-interior-cost","cheonan-apart-interior","cheonan-interior-portfolio"],
))
